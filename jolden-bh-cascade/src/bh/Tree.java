  ...
  private void makeTree(int nstep) {
    for (Enumerator e = bodies(); e.hasMoreElements();) {
      ...
      if (q.mass != 0.0) {
        ...
        // This method is always called after Tree.CreateTestData,
        // which always initializes the field pos to be within
        // bound. Since intcoord will not return null, if pos
        // is within bound, xqic can never be null at this call site.
